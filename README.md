...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/little-dream-a60d
```

A live public deployment of this template is available at [https://little-dream-a60d.templates.workers.dev](https://little-dream-a60d.templates.workers.dev)
